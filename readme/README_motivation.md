...
- **Open ended evolution** - Sprout Life allows for truly open ended evolution. We want to emulate the rise of biological complexity. To do this we've created an environment where self-sustaining structures compete and where bigger and better structures can continuously emerge.
