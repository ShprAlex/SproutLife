...
Sprout Life extends the concept of Conway’s Game of Life to enable reproduction and mutation among the patterns on the board. We treat patterns of cells like organisms. Organisms grow and reproduce according to the rules of GOL, with a couple of slight changes. We can see evolution take place as successful organisms take over the board.
