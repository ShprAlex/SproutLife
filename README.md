...
Organisms strive to find an order that's beneficial to their survival. Stable patterns arise quickly when organisms have only two children. Having 3 children, however, makes it harder to establish a stable pattern. Now two of the three children must die to maintain the status quo. That creates more permutations of possible outcomes. A landscape with many possibilities makes it harder for our evolving organism to optimize against every case. This results in chaos, a less densely populated board, and a lower population. 
