...
Reproduction is non-trivial, but not too hard either. It allows room for mutation and improvement. As organisms grow they may collide with each other and disrupt each other’s ability to make seeds. It's amazing to see that managing collisions with both friends and foes has a greater effect on an organism's success than simply being faster to create offspring.
