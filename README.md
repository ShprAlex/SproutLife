...
Enabling reproduction leads to the spontaneous emergence of more advanced behaviors. Surviving organisms begin to compete for space and align in battle formations with their siblings. Game of Life is Turing complete, so there should be no limit to how complex the evolved behavior can get.
