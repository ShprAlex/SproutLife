...
Sprout Life brings the next stage of evolution to Conway’s Game of Life. GOL defined a way for random pixels to self-organize into lifelike patterns. Sprout Life changes the rules slightly to allow these patterns to reproduce, mutate, and evolve.
