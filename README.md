...
In the first few minutes of the game, Sprout Life gives rise to 100s of diverse replicating organisms. We can watch as the organisms compete for space and align with their siblings. Evolution is open ended, so more advanced organisms continue to arise as the program runs. In future versions it could be fun to enable competitions between organisms collected by multiple users.
