...
Enabling reproduction leads to the spontaneous emergence of more advanced behaviors. Organisms begin to compete for space and align in battle formations with their siblings. Sprout Life seems to achieve "open ended evolution" -- which is a sought after result in artificial life. This requires more rigorous analysis. Game of Life is Turing complete, so there should be no limit to how complex the evolved behavior can get.
